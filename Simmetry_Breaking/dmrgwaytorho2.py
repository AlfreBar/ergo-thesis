...
def get_superblock(sys, site, env, H2):
    ...
    #print(sys_enl_op["conn_Sx"].toarray())
    #print(env_enl_op["conn_Sx"].toarray())

    #print(env_enl_op["H"].toarray())
    ...
    #print(superblock_hamiltonian.toarray())
...
def DMRG_step(sys,site,env,m,H2):
    ...
    energy, psi = eigsh(superblock, k=1, which="SA",v0=startpsi)
        
    rho=get_reduced_density_matrix(sys_enl,psi)
    ...
    return newblock, energy,psi,rho, superblock
...
def infinite_system_algorithm(block,site, L, m,H2):
    ...
    while 2 * block.length < L:
        ...
        block, energy , psi,rho,trans = DMRG_step(block, site ,block, m,H2)
        #print("E/L =", energy / (block.length * 2))
    return psi,trans,energy
